            ...
            <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        />
                    <p className="text-[12px] text-black px-2 font-normal opacity-60">Please check your inbox or spam folder to retrieve your OTP. Do not share this with anyone.</p>
